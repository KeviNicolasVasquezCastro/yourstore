...
public class loginPage {
    ...
    public static final Target url = Target.the("url de la pagina").locatedBy("//span[text()='My Account']");
    public static final Target buttonLogin = Target.the("button login").locatedBy("//a[text()='Login']");
